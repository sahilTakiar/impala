...
// A Resource Profile contains all of the information computed by the plan as part of the
// resource profile that is needed by the backend to execute. Used by PlanNodes and
// DataSinks. See ResourceProfile.java for more details.
