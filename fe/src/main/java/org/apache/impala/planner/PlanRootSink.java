...
public class PlanRootSink extends DataSink {
   ...
   * of the associated fragment's root node. If the cardinality or the average row size are
   * not available, a default value is used. The minimum reservation is set 2x the
