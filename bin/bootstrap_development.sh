...
time -p ./buildall.sh -format -testdata -skiptests -snapshot_file /tmp/test-warehouse-cdh6-796-SNAPSHOT.tar.gz -metastore_snapshot_file /tmp/hive_impala_dump_cdh6-796.txt
