...
///
/// Adds the following timers to the RuntimeProfile: 'RowBatchQueueGetWaitTime' and
/// 'RowBatchQueuePutWaitTime'. They track how long calls to AddBatch and GetBatch wait
/// for space in the queue to be available and wait for batches to be available,
/// respectively.
///
