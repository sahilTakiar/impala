...
#ifndef IMPALA_EXEC_BLOCKING_PLAN_ROOT_SINK_H
#define IMPALA_EXEC_BLOCKING_PLAN_ROOT_SINK_H
...
class BlockingPlanRootSink : public PlanRootSink {
 public:
  BlockingPlanRootSink(TDataSinkId sink_id, const RowDescriptor* row_desc, RuntimeState* state);
  ...
  virtual void Cancel(RuntimeState* state);
