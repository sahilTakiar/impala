...
def cancel_query_and_validate_state(client, query, exec_option, table_format,
  ...
  """Runs the given query asynchronously and then cancels it after the specified delay. The
  query is run with the given 'exec_options' against the specified 'table_format'. A
